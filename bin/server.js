...
res.json([{harvester1: 'http://localhost:3000/api/harvesters'}, {harvester2: 'http://localhost:3000/api/harvesters/02'}]);
});
...
harvestersRoute.post(function(req, res) {
  ...
  harvester.oillevel = 'http://localhost:3000/api/harvesters/oillevel';
  harvester.fuellevel = 'http://localhost:3000/api/harvesters/fuellevel';
  harvester.pressure = 'http://localhost:3000/api/harvesters/pressure';
